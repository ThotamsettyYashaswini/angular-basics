...
export class ContacmasterService {
    ...
    saveTypeofEnterprise(data): Observable<any> {
        ...
        try {
            return this._CommonService.callPostAPI('/loans/masters/contactmaster/SaveEnterpriseType', data);
    ...
    getTypeofEnterprise(): Observable<any> {
        ...
        try {
            return this._CommonService.callGetAPI('/loans/masters/contactmaster/GetEnterpriseType', '', 'NO');
        }
        catch (e) {
            this._CommonService.showErrorMessage(e);
        }
    ...
    GetContactDetailsList(Type,endindex,searchby) {
        try {
            const params = new HttpParams().set('ViewName', Type).set('endindex', endindex).set('searchby', searchby);
            return this._CommonService.callGetAPI('/loans/masters/contactmasterNew/GetcontactviewByNameIndex', params, 'YES');
        }
        catch (e) {
            this._CommonService.showErrorMessage(e);
        }
