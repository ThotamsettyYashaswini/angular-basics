...
export class FIIndividualService {
  ...
  Getlandbankdertails(): Observable<any> {
    try {
      return this.commonService.callGetAPI('/HomesInventory/masters/LandBank/Getlandbankdertails', '', 'NO');
    }
    catch (e) {
      this.commonService.showErrorMessage(e);
    }
  ...
  ///HomesInventory/masters/LandBank/SaveDocumentDetails

  SaveDocumentDetails(data): Observable<any> {

    try {
      return this.commonService.callPostAPI('/HomesInventory/masters/LandBank/SaveDocumentDetails', data);
  ...
  //api/HomesInventory/masters/LandBank/GetlandDocdetails
  GetlandDocdetails(landbankid): Observable<any> {
    try {
      const params = new HttpParams().set('landbankid', landbankid);
      return this.commonService.callGetAPI('/HomesInventory/masters/LandBank/GetlandDocdetails', params, 'YES');
    } catch (error) {
      this.commonService.showErrorMessage(error);
    }
  }

  deleteDocumentDetails(data){
    try {
      return this.commonService.callPostAPI('/HomesInventory/masters/LandBank/SaveDocumentDetails', data);
      }
     catch (e){
  ...
  //HomesInventory/masters/LandBank/GetCasedetails

  getCaseDetails(): Observable<any> {
    try {
      return this.commonService.callGetAPI('/HomesInventory/masters/LandBank/GetCasedetails', '', 'NO');
    }
    catch (e) {
      this.commonService.showErrorMessage(e);
    }
  ...
  saveCourtCaseDocumentDetails(data): Observable<any> {

    try {
      return this.commonService.callPostAPI('/HomesInventory/masters/LandBank/SaveCourtCaseDocumentDetails', data);
  ...
  GetcaseDocdetails(lbcaseidid): Observable<any> {
    try {
      const params = new HttpParams().set('lbcaseidid', lbcaseidid);
      return this.commonService.callGetAPI('/HomesInventory/masters/LandBank/GetcaseDocdetails', params, 'YES');
    } catch (error) {
      this.commonService.showErrorMessage(error);
    }
  }

  deleteCourtCaseDocumentDetails(data){
    try {
      return this.commonService.callPostAPI('/HomesInventory/masters/LandBank/SaveCourtCaseDocumentDetails', data);
      }
     catch (e){
