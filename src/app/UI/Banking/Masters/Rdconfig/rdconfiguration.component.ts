...
export class RdconfigurationComponent implements OnInit {
  ...
  Investmentfrom()
  {
    ...
    if(this.Rdconfigurationform.controls.lstRdConfigartionDetails['controls'].pfromnoofyears.value && 
    this.Rdconfigurationform.controls.lstRdConfigartionDetails['controls'].pfromnoofmonths.value &&
    this.Rdconfigurationform.controls.lstRdConfigartionDetails['controls'].pfromnoofdays.value) {
  ...
  Investto()
  {
    ...
    if(this.Rdconfigurationform.controls.lstRdConfigartionDetails['controls'].ptonoofyears.value && 
    this.Rdconfigurationform.controls.lstRdConfigartionDetails['controls'].ptonoofmonths.value &&
    this.Rdconfigurationform.controls.lstRdConfigartionDetails['controls'].ptonoofdays.value) {
      this.checkForFromAndToDays()
    }
  }
