 ...
 **/
  ...
  onDateChange(event) {
    ...
    console.log("selectedOnlyDate : ",selectedOnlyDate);
    console.log("presentOnlyDate : ",presentOnlyDate);
    console.log("this.forClearButton : ",this.forClearButton);
  ...
  if(this.forClearButton == true) {
    ...
    if(this.forClearButton == false) {
      ...
      // else if(this.forDatePickerCount > 0) {
      //   this.getInterestRates();
      // }
      else {  
        this.forDatePickerCount = 0;
    ...
    console.log("forDatePickerCount : ",this.forDatePickerCount);
    if(this.forDatePickerCount > 0) {
      this.getInterestRates();
    }
