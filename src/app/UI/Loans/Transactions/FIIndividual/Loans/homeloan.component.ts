...
pCountry_Change($event: any): void {
  ...
  if (countryid && countryid != '') {
        ...
        this.HomeloanForm['controls']['pcountry'].setValue(countryid);
  }
  else {
    this.stateDetails = [];
...
pState_Change($event: any): void {
  ...
  if (stateid && stateid != '') {
    ...
    this.HomeloanForm['controls']['pstate'].setValue(stateid);
...
pDistrict_Change($event: any): void {
  ...
  if (districtid && districtid != '') {
    ...
    this.HomeloanForm['controls']['pdistrict'].setValue(districtid);
  }
  else {
