...
export class FiPersonaldetailsEmploymentComponent implements OnInit {
  ...
  constructor(private _FormBuilder: FormBuilder, private _commonService: CommonService, private _FIIndividualService: FIIndividualService, private _ContacmasterService: ContacmasterService) {
