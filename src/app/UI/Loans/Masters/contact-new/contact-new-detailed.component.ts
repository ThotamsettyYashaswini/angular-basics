...
@Component({
  selector: 'app-contact-new-detailed',
  templateUrl: './contact-new-detailed.component.html',
  styles: []
})
export class ContactNewDetailedComponent implements OnInit {
  ID: string;
  DisplayCardData: any
    pContactType:any;
  ...
  NavigateReferral(RefId) {
    debugger;
    let name = "refferral";
       this._routes.navigate(['/ContactMore'], { queryParams: { ID: RefId, name: name ,contacttype:this.pContactType} })
  }
