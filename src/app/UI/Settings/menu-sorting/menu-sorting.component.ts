...
export class MenuSortingComponent implements OnInit {
  ...
  constructor(private _UsersService: MenuModulesService,private commonService : CommonService) { }
...
this.GetNavigation('','');
  ...
  GetNavigation(Type, UserOrDesignation) {
    ...
    this.loading = true;
    this._UsersService.GetNavigation1(Type, UserOrDesignation).subscribe(data => {
