...
export class LandPurchaseComponent implements OnInit {
  ...
  addLandDetailsControls(): FormGroup {
    return this.fb.group({
      ...
      companyid: [0],
      pEmployeeId: ['', [Validators.required]],
      pEmployeeName: [''],
      surveyno: ['', [Validators.required, Validators.maxLength(30)]],
      vendorname: ['', [Validators.required, Validators.maxLength(75)]],
      registereddocumentno: ['', Validators.maxLength(30)],
      //proceedingno: ['', Validators.maxLength(30)],
      registrationfee: ['', Validators.maxLength(30)],
      proceedingno: [''],
      ...
      landvalue: ['', [Validators.required, Validators.maxLength(15)]],
      northboundary: ['', [Validators.required,Validators.maxLength(75)]],
      eastboundary: ['', [Validators.required,Validators.maxLength(75)]],
      westboundary: ['', [Validators.required,Validators.maxLength(75)]],
      southboundary: ['', [Validators.required,Validators.maxLength(75)]],
      status: [true],
      ptypeofoperation: ['CREATE'],
  ...
  addLandDetailstogrid() {
    ...
    if (LandDetailstogridcontrols.controls.landvalue.value == '') {
      this._commonservice.showWarningMessage('Total land cost should not be empty...');
      return;
    }
    if (LandDetailstogridcontrols.controls.landvalue.value == 0) {
      ...
      landvalue = parseFloat(landvalue.toString().replace(/,/g, ""));
      this.LandBankform['controls']['pLandDetailsControls']['controls']['landvalue'].setValue(landvalue);
