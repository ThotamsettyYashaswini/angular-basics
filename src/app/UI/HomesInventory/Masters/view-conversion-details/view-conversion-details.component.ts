...
@Component({
  selector: 'app-view-conversion-details',
  templateUrl: './view-conversion-details.component.html',
  styles: []
})
export class ViewConversionDetailsComponent implements OnInit {
  ...
  downloadExcel(): void {
      ...
      const parentHeaders = ['Proceeding No.', 'Proceeding Date', 'Issued By'];
      const childHeaders = ['Village/Mandal', 'Survey No. ', 'Land Area','Land Area(sq.yds)'];
